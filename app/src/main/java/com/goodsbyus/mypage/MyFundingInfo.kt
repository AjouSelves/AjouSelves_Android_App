...
class MyFundingInfo : AppCompatActivity() {
    private var _binding: ActivityMyFundingInfoBinding? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_my_funding_info)

        _binding = ActivityMyFundingInfoBinding.inflate(layoutInflater)
        ...
        binding.fundingButton.setOnClickListener {
            val intent = Intent(this@MyFundingInfo, PayQr::class.java)
